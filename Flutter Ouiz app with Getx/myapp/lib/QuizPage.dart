...
class _QuizPageState extends ConsumerState<QuizPage> {
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () {
                ...
                // Optionally, navigate to a different screen or reset the quiz
                resetQuizForRetry(); // Call reset if you want to automatically restart the quiz
              },
              child: const Text('OK'),
            ),
          ],
  ...
  void resetQuizForRetry() {
    ...
    _timerController.startTimer(); // Restart the timer for the first question
    Navigator.of(context).popUntil((route) => route
        .isFirst); // Optionally, navigate back to the quiz start if using navigation
  }
