...
import 'package:myapp/OptionWidgetoffline.dart';
import 'package:myapp/quiz_model.dart';
import 'package:myapp/sample_data_withoutcounter.dart';
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage(
                  'assests/images/quizzbg.jpg'), // Your background image
                  ...
                  ...List.generate(question.options.length, (index) {
                    return OptionWidgetoffline(
                      ...
                      onSelectOption: (int selectedIndex) {
                        ...
                        // Add a delay to allow the user to see the selected answer
