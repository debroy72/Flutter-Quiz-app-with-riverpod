...
// UserResponse is used to send back a response with the username.
type UserResponse struct {
	Username string `json:"username"`
}

// QuizResult represents the result of a user's quiz attempt.
...
func getQuizResultsHandler(w http.ResponseWriter, r *http.Request) {
	...
	// This could be modified to fetch specific user results or all results
	collection := client.Database("myQuizApp").Collection("quizResults")
